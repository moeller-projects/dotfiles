...
INTENT: reduce token/tool cost by reusing stable, evidence-based analysis artifacts across iterative OpenCode sessions
...
User invocation examples (within a OpenCode session):
