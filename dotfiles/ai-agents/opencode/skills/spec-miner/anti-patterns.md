...
These are failures in how Spec Miner behaves.
...
Bad:
- using the skill for work outside derived specification or system map
- expanding into adjacent work without evidence or user need

Good:
- stay focused on the requested derived specification or system map
...
Bad:
- returning broad commentary with no usable derived specification or system map
