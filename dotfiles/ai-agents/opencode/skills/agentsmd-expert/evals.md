...
Use these prompts to detect drift in AGENTS.md Expert behavior.
...
- produces a concrete AGENTS.md guidance
...
**Input**
The current AGENTS.md already matches the repo workflows and constraints.
