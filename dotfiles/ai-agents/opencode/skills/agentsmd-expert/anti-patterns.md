...
These are failures in how AGENTS.md Expert behaves.
...
Bad:
- using the skill for work outside AGENTS.md guidance
- expanding into adjacent work without evidence or user need

Good:
- stay focused on the requested AGENTS.md guidance
...
Bad:
- returning broad commentary with no usable AGENTS.md guidance
