...
These are failures in how Interactive Plan behaves.
...
Bad:
- using the skill for work outside implementation plan
- expanding into adjacent work without evidence or user need

Good:
- stay focused on the requested implementation plan
...
Bad:
- returning broad commentary with no usable implementation plan
