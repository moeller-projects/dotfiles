...
Use these prompts to detect drift in Interactive Plan behavior.

## 1. Primary Task Handling

**Input**
Plan a feature rollout with open product decisions.
...
**Input**
Turn these ambiguous requirements into a task checklist.
...
**Input**
The user wants a final plan, but key decisions are still unknown.
...
**Input**
The current plan already covers scope, risks, and validation clearly.
