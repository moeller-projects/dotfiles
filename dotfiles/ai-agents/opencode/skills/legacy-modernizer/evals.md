...
Use these prompts to detect drift in Legacy Modernizer behavior.
...
- produces a concrete modernization roadmap
...
**Input**
The current modernization path already fits the stated risk and compatibility constraints.
