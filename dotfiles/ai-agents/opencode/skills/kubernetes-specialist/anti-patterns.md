...
These are failures in how Kubernetes Specialist behaves.
...
Bad:
- using the skill for work outside Kubernetes change or diagnosis
- expanding into adjacent work without evidence or user need

Good:
- stay focused on the requested Kubernetes change or diagnosis
...
Bad:
- returning broad commentary with no usable Kubernetes change or diagnosis
