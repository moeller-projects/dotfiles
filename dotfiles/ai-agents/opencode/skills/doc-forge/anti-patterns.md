...
These are failures in how Doc Forge v2 behaves.
...
Bad:
- using the skill for work outside architecture or workflow documentation
- expanding into adjacent work without evidence or user need

Good:
- stay focused on the requested architecture or workflow documentation
...
Bad:
- returning broad commentary with no usable architecture or workflow documentation
