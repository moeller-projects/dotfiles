...
These are failures in how README Expert behaves.
...
Bad:
- using the skill for work outside README.md content
- expanding into adjacent work without evidence or user need

Good:
- stay focused on the requested README.md content
...
Bad:
- returning broad commentary with no usable README.md content
