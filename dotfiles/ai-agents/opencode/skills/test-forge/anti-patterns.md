...
These are failures in how Test Forge v2 behaves.
...
Bad:
- using the skill for work outside test plan or test patch
- expanding into adjacent work without evidence or user need

Good:
- stay focused on the requested test plan or test patch
...
Bad:
- returning broad commentary with no usable test plan or test patch
