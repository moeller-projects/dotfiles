...
These are failures in how MVP Watcher v1.2 behaves.
...
Bad:
- using the skill for work outside scope review with keep/cut recommendations
- expanding into adjacent work without evidence or user need

Good:
- stay focused on the requested scope review with keep/cut recommendations
...
Bad:
- returning broad commentary with no usable scope review with keep/cut recommendations
