...
These are failures in how Perf Analyst v2 behaves.
...
Bad:
- using the skill for work outside performance diagnosis and optimization plan
- expanding into adjacent work without evidence or user need

Good:
- stay focused on the requested performance diagnosis and optimization plan
...
Bad:
- returning broad commentary with no usable performance diagnosis and optimization plan
