...
These are failures in how Threat Modeler v2 behaves.
...
Bad:
- using the skill for work outside threat model and mitigations
- expanding into adjacent work without evidence or user need

Good:
- stay focused on the requested threat model and mitigations
...
Bad:
- returning broad commentary with no usable threat model and mitigations
