...
Use these prompts to detect drift in Threat Modeler v2 behavior.
...
- produces a concrete threat model and mitigations
...
**Input**
The current threat model already covers the requested scope and priority level.
