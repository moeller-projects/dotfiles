...
These are failures in how Deep Research behaves.
...
Bad:
- using the skill for work outside research synthesis and evidence package
- expanding into adjacent work without evidence or user need

Good:
- stay focused on the requested research synthesis and evidence package
...
Bad:
- returning broad commentary with no usable research synthesis and evidence package
