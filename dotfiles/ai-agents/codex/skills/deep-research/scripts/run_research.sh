...
# - In a real setup, Codex can use installed web skills / MCP to gather sources
...
log "Handoff: .codex/skills/openspec/scripts/spec_from_input.sh $out/requirements.json"
