...
These are failures in how Chaos Engineer behaves.
...
Bad:
- using the skill for work outside chaos experiment plan
- expanding into adjacent work without evidence or user need

Good:
- stay focused on the requested chaos experiment plan
...
Bad:
- returning broad commentary with no usable chaos experiment plan
