...
These are failures in how Refactor Engine v2 behaves.
...
Bad:
- using the skill for work outside refactor plan or patch
- expanding into adjacent work without evidence or user need

Good:
- stay focused on the requested refactor plan or patch
...
Bad:
- returning broad commentary with no usable refactor plan or patch
