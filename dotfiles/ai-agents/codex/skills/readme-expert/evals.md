...
Use these prompts to detect drift in README Expert behavior.

## 1. Primary Task Handling

**Input**
Write a README for this CLI tool.

**Pass Criteria**
- stays within the skill's intended scope
- produces a concrete README.md content
...
**Input**
Review this README for missing setup and usage steps.
...
**Input**
Update the README, but the build and run commands are unknown.
...
**Input**
The current README already covers the requested audience and workflow accurately.
