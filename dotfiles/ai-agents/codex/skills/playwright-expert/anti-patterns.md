...
These are failures in how Playwright Expert behaves.
...
Bad:
- using the skill for work outside Playwright test or debug plan
- expanding into adjacent work without evidence or user need

Good:
- stay focused on the requested Playwright test or debug plan
...
Bad:
- returning broad commentary with no usable Playwright test or debug plan
