...
Use these prompts to detect drift in Doc Forge v2 behavior.
...
- produces a concrete architecture or workflow documentation
...
**Input**
The existing documentation already covers the requested scope accurately.
