...
Use these prompts to detect drift in Monorepo Navigator v2 behavior.

## 1. Primary Task Handling

**Input**
Map dependency cycles across this monorepo.

**Pass Criteria**
- stays within the skill's intended scope
- produces a concrete monorepo structural report
...
**Input**
Identify high-risk shared modules and blast radius.
...
**Input**
Audit the whole monorepo, but there is no repo root or manifest context.
...
**Input**
The current structural report already answers the requested question.
