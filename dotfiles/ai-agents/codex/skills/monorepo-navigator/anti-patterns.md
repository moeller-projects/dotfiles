...
These are failures in how Monorepo Navigator v2 behaves.
...
Bad:
- using the skill for work outside monorepo structural report
- expanding into adjacent work without evidence or user need

Good:
- stay focused on the requested monorepo structural report
...
Bad:
- returning broad commentary with no usable monorepo structural report
