...
Use these prompts to detect drift in Test Forge v2 behavior.
...
- produces a concrete test plan or test patch
...
**Input**
The current tests already cover the changed behavior adequately.
