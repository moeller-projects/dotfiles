...
These are failures in how Budget Guard v2.1 behaves.
...
Bad:
- using the skill for work outside budget-safe execution plan
- expanding into adjacent work without evidence or user need

Good:
- stay focused on the requested budget-safe execution plan
...
Bad:
- returning broad commentary with no usable budget-safe execution plan
