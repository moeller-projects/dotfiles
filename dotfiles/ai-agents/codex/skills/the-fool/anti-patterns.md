...
These are failures in how The Fool behaves.
...
Bad:
- using the skill for work outside structured challenge or critique
- expanding into adjacent work without evidence or user need

Good:
- stay focused on the requested structured challenge or critique
...
Bad:
- returning broad commentary with no usable structured challenge or critique
