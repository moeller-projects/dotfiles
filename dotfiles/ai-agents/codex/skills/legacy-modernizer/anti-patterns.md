...
These are failures in how Legacy Modernizer behaves.
...
Bad:
- using the skill for work outside modernization roadmap
- expanding into adjacent work without evidence or user need

Good:
- stay focused on the requested modernization roadmap
...
Bad:
- returning broad commentary with no usable modernization roadmap
