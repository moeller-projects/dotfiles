...
Use these prompts to detect drift in OpenSpec Expert v2.1 behavior.
...
- produces a concrete OpenSpec document or review
...
**Input**
The current spec already satisfies the requested OpenSpec quality bar.
